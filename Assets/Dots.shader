...
Shader "Dots"
{
	Properties
	{
		...
		[ASEEnd]_ShadowDotSize("ShadowDotSize", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult37 = (float2(ase_screenPosNorm.x , ase_screenPosNorm.y));
				float2 break39 = ( appendResult37 / ase_screenPosNorm.w );
				float2 appendResult42 = (float2(break39.x , ( break39.y * ( _ScreenParams.y / _ScreenParams.x ) )));
				float2 break16_g1 = (appendResult42*_Size + 0.0);
				...
				float temp_output_2_0_g1 = ( ( 1.0 - ase_lightAtten ) * _ShadowDotSize );
				...
				float4 lerpResult24 = lerp( ( ( 1.0 - saturate( ( ( 1.0 - temp_output_17_0_g2 ) / fwidth( temp_output_17_0_g2 ) ) ) ) * _Color0 ) , _Color0 , ase_lightAtten);
...
/*ASEBEGIN
Version=18935
570;-1219;1706;890;2815.863;915.9416;1.3;True;False
Node;AmplifyShaderEditor.ScreenPosInputsNode;27;-2449.211,-22.10283;Float;False;0;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;37;-2225.64,-69.0958;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;38;-2073.864,12.40341;Inherit;False;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ScreenParams;32;-2188.92,-319.2568;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.BreakToComponentsNode;39;-1927.901,36.61659;Inherit;False;FLOAT2;1;0;FLOAT2;0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SimpleDivideOpNode;41;-1910.033,-158.0413;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LightAttenuation;9;-1337.685,650.4646;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;40;-1774.41,93.07299;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;50;-1332.689,285.9126;Inherit;False;Property;_ShadowDotSize;ShadowDotSize;2;0;Create;True;0;0;0;False;0;False;1;1.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;42;-1635.874,39.35512;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.OneMinusNode;45;-1142.598,174.4769;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;30;-1631.321,178.1226;Inherit;False;Property;_Size;Size;1;0;Create;True;0;0;0;False;0;False;1,1;150,150;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.ScaleAndOffsetNode;31;-1420.286,134.1181;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;1,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;46;-979.2499,183.3773;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;1.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;26;-850.7372,-149.2319;Inherit;True;Dots Pattern;-1;;1;7d8d5e315fd9002418fb41741d3a59cb;1,22,1;5;21;FLOAT2;0,0;False;3;FLOAT2;15,15;False;2;FLOAT;0.85;False;4;FLOAT;1;False;5;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;43;-562.4471,-162.0386;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;8;-759.5677,154.3501;Inherit;False;Property;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;49;-434.6723,-62.23044;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;24;-274.3548,171.916;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FractNode;51;-1657.563,-488.2416;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;52;-1539.263,-401.1416;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;37;1;27;2
WireConnection;38;0;37;0
WireConnection;38;1;27;4
WireConnection;39;0;38;0
WireConnection;41;0;32;2
WireConnection;41;1;32;1
...
ASEEND*/
//CHKSM=114E864C8C54B0907F77056BBE0283CF6D397E25